<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      <h3 class="title">云理财</h3>
      <el-form-item prop="mail">
        <span class="svg-container">
          <svg-icon icon-class="user" />
        </span>
        <el-input v-model="loginForm.mail" name="mail" type="text" auto-complete="on" placeholder="邮箱" />
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleRegister() {
      window.location.href = 'http://139.196.107.185:8088/#/register'
